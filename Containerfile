...
LABEL \
        ...
        org.opencontainers.image.description="Helper for authentication for Matrix HomeserversProxy to your Matrix HomeserverAntivirus Scanner" \
...
ENV NGINX_SITE_ENABLED=matrix-authentication-service \
